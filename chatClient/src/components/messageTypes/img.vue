<template>
  <div class="message-type__img">
    <img v-show="!imgLoading" height="200" style="cursor: zoom-in" :src="message.message" alt="图片加载失败" @load="load"
      @click="setshowPicturePreview(true)" @error="imgError">
    ...
    <transition name="fade">
      <picture-preview v-if="showPicturePreview" :current-img="message.message" :img-list="imgUrlList"
